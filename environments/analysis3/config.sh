...
export VERSION_TO_MODIFY=26.03
...
declare -a outside_files_to_copy=( "/g/data/xp65/public/apps/openmpi/5.0.8" )
declare -a replace_with_external=( "/g/data/xp65/public/apps/openmpi/5.0.8" )
